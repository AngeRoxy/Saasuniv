...
void main(void) {
  ...
  uv*=1.-.3*(sin(T*.2)*.5+.5);
  vec3 phase=mix(vec3(1,2,3),vec3(3,2,5),u_theme);
...
void main(){gl_Position=position;}`;
    ...
    const onTheme = (e: Event) => {
      themeRef.current = (e as CustomEvent<{ blue: boolean }>).detail.blue ? 1.0 : 0.0;
    };
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-orange-300 animate-fade-in-up [animation-delay:200ms]">
              {headline.line1}
            </h1>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-yellow-300 animate-fade-in-up [animation-delay:400ms]">
              {headline.line2}
            </h1>
          </div>

          <div className="max-w-3xl mx-auto animate-fade-in-up [animation-delay:600ms] opacity-0">
          ...
          {buttons && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up [animation-delay:800ms] opacity-0">
              {buttons.primary && (
                <button
