  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Total absences', value: absences.length, color: 'text-white' },
            ...
            <tbody>
              {absences.map((a) => (
                <tr key={a.id} className="border-t border-orange-500/5">
                  <td className="px-4 py-3 text-orange-100/80 whitespace-nowrap">{a.date ? new Date(a.date).toLocaleDateString('fr-FR') : '—'}</td>
                  <td className="px-4 py-3 text-orange-100/70">{a.matiere || '—'}</td>
