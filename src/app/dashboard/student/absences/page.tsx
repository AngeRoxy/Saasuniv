...
export default function StudentAbsencesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Mes absences</h1>
        <p className="text-zinc-500 dark:text-orange-200/40 text-sm mt-1">Suivi de votre assiduité.</p>
      </div>
