...
export default function GradesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Consultation des notes</h1>
        <p className="text-orange-200/40 text-sm mt-1">Supervision des résultats. La saisie est réservée aux enseignants.</p>
      </div>
