  ...
  return (
    <>
      <div className="max-w-2xl space-y-6">
        ...
        {/* Avatar + name */}
        <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-orange-500/10 rounded-2xl p-6 flex items-center gap-5">
          <div className="w-16 h-16 rounded-2xl bg-orange-500/20 border border-orange-500/30 flex items-center justify-center shrink-0">
            <User size={28} className="text-blue-600 dark:text-orange-400" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-zinc-900 dark:text-white text-xl font-bold truncate">{displayName || 'Administrateur'}</p>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm mt-0.5 truncate">{user?.email}</p>
            <span className="inline-flex items-center gap-1.5 mt-2 px-2.5 py-1 rounded-lg bg-orange-500/10 border border-orange-500/20 text-blue-600 dark:text-orange-400 text-xs font-medium">
              <Shield size={11} />
          ...
          <button
            onClick={openModal}
            className="shrink-0 flex items-center gap-2 px-3 py-2 rounded-xl bg-orange-500/10 border border-orange-500/20 text-blue-600 dark:text-orange-400 text-sm font-medium hover:bg-orange-500/20 transition-colors"
          >
            <Pencil size={14} />
            Modifier le profil
          </button>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-zinc-900 dark:text-white text-sm font-medium">{displayName || '—'}</p>
              </div>
            </div>
            ...
            {title && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-900 dark:text-white text-sm font-medium">{title}</p>
                </div>
              </div>
            )}
            ...
            {phone && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-900 dark:text-white text-sm font-medium">{phone}</p>
                </div>
              </div>
            )}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <p className="text-zinc-900 dark:text-white text-sm font-medium font-mono">{profile?.universityId ?? '—'}</p>
                  {profile?.universityId && (
                    <button
                      onClick={copyUniversityId}
                      className="flex items-center gap-1 px-2 py-0.5 rounded-md text-xs transition-colors bg-orange-500/10 border border-orange-500/20 text-blue-600 dark:text-orange-400 hover:bg-orange-500/20"
                    >
        ...
        <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-orange-500/10 rounded-2xl p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-zinc-50 dark:bg-black/40 rounded-xl p-4">
              ...
              <p className="text-zinc-900 dark:text-white text-sm font-medium">{createdAt}</p>
            </div>
            <div className="bg-zinc-50 dark:bg-black/40 rounded-xl p-4">
              <p className="text-xs text-zinc-500 mb-1">UID Firebase</p>
              <p className="text-zinc-600 dark:text-zinc-400 text-xs font-mono truncate">{user?.uid ?? '—'}</p>
            </div>
            <div className="bg-zinc-50 dark:bg-black/40 rounded-xl p-4">
              <p className="text-xs text-zinc-500 mb-1">Email vérifié</p>
              <p className={`text-sm font-medium ${user?.emailVerified ? 'text-green-400' : 'text-blue-600 dark:text-yellow-400'}`}>
        ...
        <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-orange-500/10 rounded-2xl p-6 space-y-5">
          <div className="flex items-center gap-2">
            <Lock size={15} className="text-blue-600 dark:text-orange-400" />
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-zinc-50 dark:bg-black/40 border border-zinc-200 dark:border-orange-500/10 rounded-xl px-4 py-2.5 pr-10 text-sm text-zinc-900 dark:text-white placeholder-zinc-600 focus:outline-none focus:border-orange-500/40 transition-colors"
                />
                <button
                  type="button"
            ...
            {pwMessage && (
              <p className="text-sm text-blue-600 dark:text-orange-400 bg-orange-500/10 border border-orange-500/20 rounded-xl px-4 py-3">
                {pwMessage}
              </p>
            )}
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-orange-500 hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold transition-colors"
            >
          ...
          <div className="relative w-full max-w-md bg-white dark:bg-zinc-950 border border-orange-500/20 rounded-2xl p-6 space-y-5 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    placeholder="Prénom"
                    className="w-full bg-zinc-50 dark:bg-black/40 border border-zinc-200 dark:border-orange-500/10 rounded-xl px-4 py-2.5 text-sm text-zinc-900 dark:text-white placeholder-zinc-600 focus:outline-none focus:border-orange-500/40 transition-colors"
                  />
                </div>
                <div className="space-y-1">
                  <label className="text-xs text-zinc-600 dark:text-zinc-400">Nom</label>
                  <input
                    type="text"
                    value={lastName}
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-50 dark:bg-black/40 border border-zinc-200 dark:border-orange-500/10 rounded-xl pl-9 pr-4 py-2.5 text-sm text-zinc-900 dark:text-white placeholder-zinc-600 focus:outline-none focus:border-orange-500/40 transition-colors"
                  />
                </div>
              </div>

              <div className="space-y-1">
                <label className="text-xs text-zinc-600 dark:text-zinc-400">Poste / Titre</label>
                <div className="relative">
              ...
              <div className="space-y-1">
                ...
                <div className="w-full bg-zinc-50 dark:bg-black/20 border border-zinc-200 dark:border-white/5 rounded-xl px-4 py-2.5 text-sm text-zinc-500 cursor-not-allowed select-none">
                  {user?.email ?? '—'}
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="w-full bg-zinc-50 dark:bg-black/20 border border-zinc-200 dark:border-white/5 rounded-xl px-4 py-2.5 text-sm text-zinc-500 font-mono cursor-not-allowed select-none">
                  {profile?.universityId ?? '—'}
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-1">
              ...
              <button
                onClick={saveModal}
                disabled={savingInfo}
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-white text-sm font-semibold transition-colors"
              >
