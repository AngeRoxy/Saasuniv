  ...
  return (
    <div className="space-y-8 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-orange-300/40 mt-1">Informations enseignant et sécurité du compte</p>
      </div>
      ...
      <div className="rounded-xl bg-zinc-950 border border-orange-500/10 overflow-hidden">
        ...
        <div className="px-6 pb-6">
          <div className="-mt-9 mb-4 flex items-end gap-4">
            <div className="w-16 h-16 rounded-full bg-orange-500 border-4 border-zinc-950 flex items-center justify-center shadow-lg shrink-0">
              <User className="h-8 w-8 text-white" />
            </div>
            <span className="mb-1 inline-flex items-center rounded-full bg-orange-500/15 border border-orange-500/30 px-3 py-0.5 text-xs font-semibold text-orange-400 uppercase tracking-wider">
              Enseignant
            </span>
          </div>
          <h2 className="text-xl font-bold text-white">{displayName || 'Enseignant(e)'}</h2>
      ...
      {/* Editable info */}
      <div>
        <h2 className="text-sm font-semibold text-orange-100/80 mb-4">Informations modifiables</h2>
        <div className="rounded-xl bg-zinc-950 border border-orange-500/10 p-6">
          <form onSubmit={handleInfoSubmit} className="space-y-4 max-w-md">
            ...
            <button
              type="submit"
              disabled={savingInfo}
              className="flex items-center justify-center gap-2 py-2.5 px-5 rounded-xl bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-black text-sm font-semibold transition-colors"
            >
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          <h2 className="text-sm font-semibold text-orange-100/80">Informations gérées par l&apos;université</h2>
